---
name: ultracode
description: Ultracode-style dynamic workflows for Cursor Agent. Use when the user says "ultracode", "workflow:", "/deep-research", or wants broad multi-file work with planning, parallel execution, verification, or crash-resume.
---
